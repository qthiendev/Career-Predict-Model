...
career_codes_path = f'./data/{model_version}/careers.csv'
responses_path = f'./data/{model_version}/responses.csv'

model_path = f'./models/{model_version}/career_predictor_model.pkl'
...
def predict_career(responses):
    predicted_code = model.predict([responses])[0]
